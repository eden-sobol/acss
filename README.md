...
you can mix them, for example, <code><p a t-si b-bl position="relative" top="20px" left="10px" f-bw="2px" f-bc="red" fs="3rem" b="5px solid green" br="15px">mixed</p></code> will provide: <p style="color: silver;background-color:blue;-webkit-text-stroke:2px;-webkit-text-stroke-color: red;font-size:3rem;width:max-content;border:5px solid green;border-radius:15px;">mixed</p>
